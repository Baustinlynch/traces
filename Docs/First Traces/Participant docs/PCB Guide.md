...
![Registration Page](assets/first_traces/easyeda-register.png)
...
![Importing the Project](assets/first_traces/easyeda-import.png)
...
![Schematic View](assets/first_traces/easyeda-schematic.png)
...
![Convert to PCB](assets/first_traces/easyeda-convert.png)
...
![Initial Layout](assets/first_traces/easyeda-layout-start.png)
...
![Routing Traces](assets/first_traces/easyeda-routing.png)
...
![DRC Error Example](assets/first_traces/easyeda-drc-error.png)
...
![Exporting Gerbers 1](assets/first_traces/easyeda-export-1.png)
![Exporting Gerbers 2](assets/first_traces/easyeda-export-2.png)
